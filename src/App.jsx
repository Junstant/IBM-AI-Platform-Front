...
import { Shield, Plus, Sparkles, Cpu } from 'lucide-react';
...
const NLPPage = () => (
  <div className="p-6">
    <h1 className="text-2xl font-bold text-ibm-gray-90 mb-4">Procesamiento de Lenguaje Natural</h1>
    <div className="bg-white rounded-lg p-8 text-center border border-ibm-gray-20">
      <p className="text-ibm-gray-70">Página de NLP en desarrollo...</p>
    </div>
  </div>
);
  ...
  <div className="p-6 space-y-6 bg-ibm-gray-10 min-h-screen">
    <div className="bg-white rounded-lg p-6 shadow-sm border border-ibm-gray-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link
          to="/fraud-detection"
          className="group bg-gradient-to-r from-ibm-red via-danger to-ibm-orange text-white rounded-lg p-6 hover:scale-105 transition-transform duration-200"
        >
          ...
          <p className="text-sm opacity-90 mb-4">
            Modelo entrenado para detectar transacciones fraudulentas en tiempo real
          </p>
